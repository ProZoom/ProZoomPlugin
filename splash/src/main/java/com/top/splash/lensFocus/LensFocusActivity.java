package com.top.splash.lensFocus;
...
public class LensFocusActivity extends Activity {
	...
	private void initPicture() {
		mPicture_1 = getResources().getDrawable(R.color.blueviolet);
		mPicture_2 = getResources().getDrawable(R.color.yellow);
		mPicture_3 = getResources().getDrawable(R.color.skyblue);
	}
